...
db.getCollection("menus").insert([ {
    _id: ObjectId("642651bbe4b4f16cd3e813bd"),
    parentId: [
        null
    ],
    createTime: ISODate("2023-03-31T03:18:05.893Z"),
    updateTime: ISODate("2023-03-31T03:35:58.788Z"),
    menuType: "1",
    menuState: NumberInt("1"),
    menuName: "常用功能",
    path: "/common",
...
db.getCollection("menus").insert([ {
    _id: ObjectId("642651d3e4b4f16cd3e813c1"),
    parentId: [
        ObjectId("642651bbe4b4f16cd3e813bd")
    ],
    createTime: ISODate("2023-03-31T03:18:05.893Z"),
    updateTime: ISODate("2023-03-31T03:36:05.737Z"),
    menuType: "1",
    menuState: NumberInt("1"),
    menuName: "文件上传",
    path: "/common/upload",
